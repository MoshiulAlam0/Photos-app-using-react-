...
const MainPhotoCon = ({ color, searchText, imgType, pageSize }) => {
  ...
  return (
    <div id="gallery-con" className="w-full px-8 pb-28 relative">
      ...
      <div style={{display:mainApiData.total !==0?'block': 'none'}} className="absolute bottom-2 left-1/2 -translate-x-1/2 border-solid border-[#b4b4b41f] bg-[#f7f7f7] hover:bg-[#17ff7809] rounded-md border-[1px] text-center moreBtn capitalize text-[#bbba] hover:text-black transition-all cursor-pointer  tracking-[1vmin] text-[1.7rem] w-[96%] py-1"
